...
/********************************************************************************************************************************************************/
    ...
    while (av_read_frame(pFormatCtx, &packet) >= 0) 
    {
        if (packet.stream_index == videoStream) 
        {
              ...
              //
              // NOTE:  @Khalil ************************************************************************************************
              //       16 bits Mono audio @ 44100hz is 88200 bytes buffer (or 8.82Kb) per second. 
              //       to match a frame on a 25 fps video we would need to buffer our audio at 88200 / 25 = 3528 bytes
              //       so our audio buffer would be 3528 bytes per frame.
